...
namespace Tellurian.Trains.WiThrottles.Tests.Integration;
...
public class SimulatedWiFredTests
{
    ...
    private static (WiThrottleTcpServer Server, RecordingLocoController Recorder, int Port) CreateServer()
    {
        ...
        var serverSettings = Options.Create(new WiThrottleSettings
        {
            Port = port,
        ...
        var server = new WiThrottleTcpServer(
            serverSettings,
            controller,
            NullLoggerFactory.Instance,
            NullLogger<WiThrottleTcpServer>.Instance);
